...
SECRET_KEY = 'nw@t-7p4su#rua=rb6106xc1)3pw3$8k_(!ddi!8k#z)n8hzm@'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR,'templates/xchange'),
            os.path.join(BASE_DIR,'templates/tv'),
            os.path.join(BASE_DIR,'templates/ideal'),
